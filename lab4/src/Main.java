...
public class Main implements DoubleArrayReader, ArrayProcessor
{
    ...
    {
        Main main = new Main();
        double[] arr = main.readOneDimensionalArray("C:/Users/Admin/OOPLabs/lab4/src/lab51.txt");
        main.processArray(arr);
        System.out.println(main.calculate(arr));
        double[][] arr2 = main.readTwoDimensionalArray(new File("C:/Users/Admin/OOPLabs/lab4/src/lab52.txt"));
